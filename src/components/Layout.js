          ...
          <div className="container-fluid">
            <div className="navbar-header">
              <ul className="nav navbar-nav">
                <li style={navTitle}>
                  <Link activeClassName='selected' to="/">Majestic Thai </Link>
                </li>
                <li>
                  <Link activeClassName='selected' to="/Menu">Menu </Link>
                </li>
                <li>
                  <Link activeClassName='selected' to="/Findus">Find Us </Link>
                </li>
                <li>
